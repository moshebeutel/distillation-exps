...
def resnetgen(out_dim=10):
    ...
    candscf10 = {
        ...
        'kwargs': [
            ...
            # {'in_H': 32, 'in_W': 32, 'num_layers': 3, 'out_dim': out_dim,
            # 'blocks_list': [7, 7, 7], 'emb_list': [16, 32, 64], 'stride_list': [1, 2, 2]},
            # {'in_H': 32, 'in_W': 32, 'num_layers': 3, 'out_dim': out_dim,
            # 'blocks_list': [9, 9, 9], 'emb_list': [16, 32, 64], 'stride_list': [1, 2, 2]},
        ],
    }
    candscf100 = {
        'fn': ResidualCNN,
        'kwargs': [
            ...
            'blocks_list': [9, 9, 9], 'emb_list': [16, 32, 64], 'stride_list': [1, 2, 2]},
            {'in_H': 32, 'in_W': 32, 'num_layers': 3, 'out_dim': out_dim,
            'blocks_list': [18, 18, 18], 'emb_list': [16, 32, 64], 'stride_list': [1, 2, 2]},
            {'in_H': 32, 'in_W': 32, 'num_layers': 3, 'out_dim': out_dim,
