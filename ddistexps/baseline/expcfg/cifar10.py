...
import copy
EXP_SMALL = copy.deepcopy(EXP_LARGE)
EXP_SMALL['meta']['gridgen'] = 'resnetsmall'
EXP_SMALL['train_cfg']['num_epochs'] = [90]

EXPERIMENTS = { 'cifar10-small': EXP_SMALL, 'cifar10-large': EXP_LARGE}
